...
0x81, 0x9c, 0x59, 0xfc, 0xac, 0xa7, 0x02, 0x3b, 0x13, 0x87, 0x5e, 0xf6, 0x3e, 0xf9, 0x8d, 0xf3, 0x14, 0xde, 0x2a, 0x6a, 0x56, 0xd3, 0x14, 0xf6, 0x3c, 0xb9, 0x8c, 0x23, 0x4b, 0x55, 0xf5, 0x06, 0xaf, 0xf6, 0x47, 0x5d, 0x29, 0x57, 0x89, 0xc6, 0x6a, 0x11, 0xcd, 0xde, 0xc1, 0x60, 0x2e, 0xf1, 0xc4, 0xa2, 0x44, 0x14, 0x16, 0x8f, 0xe9, 0xba, 0x10, 0x36, 0xba, 0x28, 0x6b, 0x47, 0xea, 0x07]
  ...
  func testProfileKeyIntegration() throws {
    ...
    let profileKey  = try ProfileKey(contents: TEST_ARRAY_16)
    let profileKeyCommitment = try profileKey.getCommitment()
    ...
    let profileKeyCiphertext   = try clientZkGroupCipher.encryptProfileKey(randomness: TEST_ARRAY_32_4, profileKey: profileKey)
    let decryptedProfileKey    = try clientZkGroupCipher.decryptProfileKey(profileKeyCiphertext: profileKeyCiphertext)
    ...
    let pkvB = try profileKey.getProfileKeyVersion()
  ...
  func testErrors() throws {
    var ckp: [UInt8] = Array(repeating: 255, count: GroupSecretParams.SIZE)
    do {
