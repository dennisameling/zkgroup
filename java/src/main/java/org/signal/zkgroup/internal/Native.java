...
public final class Native {
  ...
  public static native int profileKeyGetCommitmentJNI(byte[] self, byte[] output);
  public static native int profileKeyGetProfileKeyVersionJNI(byte[] self, byte[] output);
